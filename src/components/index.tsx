  ...
  return (
    <main>
      ...
      <section>
        ...
        <Flex direction="column" gap={2}>
          <Text>
            {bold("Project")}: {LINK.nirvana} — a mission-critical internal
            infrastructure platform used by 2,000+ developers daily for ML
            pipelines and data processing.
          </Text>
          <Text>{bold("Tech Stack in Nirvana team")}:</Text>
          <ul>
            <li>
              {LINK.typescript}, {LINK.lit} (migrating to {LINK.react}),{" "}
              {LINK.reduxToolkit}, {LINK.scss}.
            </li>
            <li>
          ...
          <ul>
            <li>
              {bold("Strategic Migration")}: Leading the architectural
              transition from {LINK.lit} to {LINK.react}. Designed and
              implemented a custom bridge to render {LINK.react} components
              within the legacy {LINK.lit} environment, allowing for a seamless,
              incremental migration of complex pages and dialogs without service
              disruption.
            </li>
            <li>
              {bold("Infrastructure & Modularization")}: Successfully decoupled
              the monolithic "Nirvana" frontend into independent,
              domain-specific services (Layers, Domain Constructor). Established
              standalone repositories and CI/CD pipelines, significantly
              improving delivery speed and team autonomy.
            </li>
            <li>
              {bold("Architectural Solutions")}: Engineered a global Dialog
              Manager capable of rendering into the document body to bypass
              legacy CSS/DOM constraints, ensuring consistent UI behavior across
              both {LINK.lit} and {LINK.react} contexts.
            </li>
            <li>
              {bold("State Management")}: Developed lazy-loading Redux Toolkit
              modules that maintain backward compatibility with custom legacy
              Redux implementations, enhancing the developer experience and
              improving application stability and significantly reducing
              production regressions caused by legacy state conflicts.
            </li>
            <li>
              {bold("Shared Tooling")}: Created and currently maintain{" "}
              {code("@yandex-data-ui/nirvana-common")} (internal npm package),
              standardizing business logic and UI patterns across the Nirvana
              services ecosystem.
            </li>
            <li>
              {bold("Growth")}: Rapidly promoted from Intern to Senior Engineer
              within 4 years, consistently delivering high-impact solutions for
              Yandex's internal cloud and developer tools.
            </li>
          </ul>
        </Flex>
      </section>
      ...
      <section>
        ...
        <Flex direction="column" gap={1}>
          <Text>
            Core: {LINK.typescript}, {LINK.react}, {LINK.nodeJS},{" "}
            {LINK.electron}.
          </Text>
          <Text>Styling: {LINK.scss}, CSS Modules.</Text>
          <Text>
            Tools: {LINK.git}, {LINK.docker}, {LINK.vite}, {LINK.webpack},
            CI/CD.
          </Text>
          <Text>
            Libraries: {LINK.lit}, {LINK.reduxToolkit}, {LINK.express},{" "}
            {LINK.gravityUi}.
          </Text>
        </Flex>
      </section>
